...
#parser.add_argument('--acquisition_function', type=str, default="EI", help='the acquisition function used for Bayesian optimisation. Must be one of [EI, ES] , where EntropySearch makes use of F-LITE to scale to large problem sizes')
...
for i in range(0, args.n_observations):
    ...
    if args.timeit:
        ...
        print(f'{time.perf_counter() - start_time} seconds for EI.')
